...
public class ListStreamUsage {
    ...
    public static Optional<DeferredCalculationExecution> getDeferedData(String asd) {
        List<DeferredCalculationExecution> deferredCalcExeList = Arrays.asList(new DeferredCalculationExecution("68", "test2"),
    ...
    public static void main(String[] args) {
        List<DeferredCalculationExecution> deferredCalcExeList = Arrays.asList(new DeferredCalculationExecution("56", "test2"),
        new DeferredCalculationExecution("56", "tes2"), new DeferredCalculationExecution("57", "tes2"));
